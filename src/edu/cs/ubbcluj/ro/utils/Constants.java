...
public class Constants {
    ...
    //Concessions
    public static final String VIEW_CONCESSIONS = "Vizualizare \"Registrul anual de evidenta a contractelor de concesiune\"";
    public static final String CONCESSIONS_PAGE = "Concessions.jsp";
    public static final String CONCESSION_MANAGEMENT_PAGE = "ConcessionManagement.jsp";
    ...
    public static final String HEADER3 = "Redevenţa";
    ...
    public static final String HISTORY = "Istoricul modificarilor";
